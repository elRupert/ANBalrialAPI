...
@RestController
@RequestMapping("/api")
public class DelUbPrController {
    ...
    @DeleteMapping("/ubicacionProyectos/{id}")
    public void elminarUbicacionProyectos(@PathVariable int id) throws SQLException {
        ...
        if (ubicacionProyecto == null) {
            ...
            ubicacionProyectoDAO.eliminar(id);
